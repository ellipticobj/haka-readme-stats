...
async def init_download_manager(user_login: str):
    ...
    await DownloadManager.load_remote_resources(
        ...
        waka_latest=f"https://waka.hackclub.com/api/v1/users/current/stats/last_7_days?api_key={EM.WAKATIME_API_KEY}",
        waka_all=f"https://waka.hackclub.com/api/v1/users/current/all_time_since_today?api_key={EM.WAKATIME_API_KEY}",
